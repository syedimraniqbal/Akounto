...
public class InvoiceRequest {
    ...
    public InvoiceRequest(int id,int invoiceNo,double custExchangeRate2, double exchangeRate2, int headTransactionCustomerId2, int paymentDueDays2, String paymentDue2, String invoiceDate2, List<Object> invoiceTransaction2, String custCurrency2, String notes2, String poNumber2, String name2,String invoiceNoPS,int discountType,double discount) {
        this.id=id;
        this.invoiceNo=invoiceNo;
        this.invoiceNoPS=invoiceNoPS;
        this.custExchangeRate = custExchangeRate2;
